package com.mdsujan.staticKeyword;

import com.mdsujan.finalKeyword.User;
...
public class StaticKeyword {
    ...
    public static void main(String[] args) {
        // the class com.mdsujan.finalKeyword.User also uses a static class variable called count
